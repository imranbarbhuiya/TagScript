 ...
 *
 * @note Devs need to check for this property in {@link https://tagscript.js.org/classes/tagscript.Response.html#actions Response.actions} and if true, don't output of the command used.
 */
