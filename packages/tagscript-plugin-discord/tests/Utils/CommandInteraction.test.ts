...
import { ChannelTransformer, MemberTransformer, resolveCommandOptions, RoleTransformer } from '../../src';
import { channel, interaction, member, role } from '../Structures/Structures';
