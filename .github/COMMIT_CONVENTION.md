...
Appears under "Bug Fixes" header, `Filter` subheader, with a link to issue #28:

```
fix(Filter): handle events correctly
...
```
revert: chore: add labels

This reverts commit a6fff12bd7c03bd1883e2efb7ce5540103caad8b.
```
